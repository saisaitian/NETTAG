...
from utils import load_dataset, feature_generator, adj_polynomials, l2_reg_loss, cluster_infer, cluster_number, \
    to_sparse_tensor
...
def retrieve_clusters(args):
    ...
    gnn = PolyGCN(input_dim=feat.shape[1], hidden_dims=args.hidden_size, output_dim=args.K,
                  batch_norm=args.batch_norm, adj_pow=(args.adjpow + 1), dropout=args.dropout,
                  rand_seed=args.rand_seed).to(device)
